...
<?php if ( is_single() ) : ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog--post--item mb-50 format-search' );?>>
...
<?php else: ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog--post--item mb-40 format-search' );?> >
