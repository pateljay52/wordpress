...
class TP_Core_Plugin {
    ...
    public function tp_core_elementor_category($manager)
    {
        $manager->add_category(
            'tpcore',
            array(
                'title' => esc_html__('Suxnix Addons', 'tpcore'),
                'icon' => 'eicon-banner',
            )
        );
    }
    ...
    public function tp_add_custom_icons_tab($tabs = array()){
        ...
        $tabs['tg-feather-icons'] = array(
            ...
            'label' => esc_html__('TG - Feather Icons', 'tpcore'),
            'labelIcon' => 'tp-icon',
            'prefix' => '',
            'displayPrefix' => 'tp',
        ...
        $tabs['tg-flat-icons'] = array(
            'name' => 'tg-flat-icons',
            'label' => esc_html__('TG - Flat Icons', 'tpcore'),
            'labelIcon' => 'tp-icon',
            'prefix' => '',
            'displayPrefix' => 'tp',
        ...
        $tabs['tg-fontawesome-icons'] = array(
            ...
            'label' => esc_html__('TG - Fontawesome Light', 'tpcore'),
            'labelIcon' => 'tp-icon',
            'prefix' => 'fa-',
            'displayPrefix' => 'fal',
